...
<section class="h-[90vh] flex flex-col items-center justify-center bg-gray-50 px-6 text-center" data-aos="fade-in" data-aos-duration="800">
  <div class="max-w-xl">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      ...
      <a href="{{ url('/#kontak') }}" class="border border-[#7CB518] text-[#7CB518] hover:bg-[#7CB518] hover:text-white font-semibold text-base md:text-lg px-6 py-3 rounded-xl shadow transition duration-200">
        Hubungi Kami
      </a>
    </div>
  </div>
