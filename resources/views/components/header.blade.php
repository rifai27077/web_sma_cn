...
>
      ...
      <div class="flex items-center gap-10">
        ...
        <nav class="hidden md:flex items-center gap-6 text-sm font-medium text-gray-800">
          ...
          <div class="relative" @mouseenter="dropdown = 'profil'" @mouseleave="dropdown = null">
            ...
            >
              <a href="#foundation" class="block px-4 py-2.5 hover:bg-gray-50 hover:text-[#699D15] transition">Yayasan</a>
              <a href="#school" class="block px-4 py-2.5 hover:bg-gray-50 hover:text-[#699D15] transition">Sekolah</a>
              <a href="#vision-mission" class="block px-4 py-2.5 hover:bg-gray-50 hover:text-[#699D15] transition">Visi & Misi</a>
            </div>
          </div>
          ...
          <div class="relative" @mouseenter="dropdown = 'akademik'" @mouseleave="dropdown = null">
            ...
            <div
              ...
              class="absolute left-0 mt-2 w-52 bg-white shadow-lg/30 shadow-md rounded-xl border border-gray-100 py-2 z-40"
            >
              <a href="#majors" class="block px-4 py-2.5 hover:bg-gray-50 hover:text-[#699D15] transition">Jurusan</a>
              <a href="#extracurricular" class="block px-4 py-2.5 hover:bg-gray-50 hover:text-[#699D15] transition">Ekstrakurikuler</a>
  ...
  >
    <nav class="flex flex-col gap-2 text-gray-800 font-medium">
      <a href="#foundation" class="py-2">Yayasan</a>
      <a href="#school" class="py-2">Sekolah</a>
      <a href="#vision-mission" class="py-2">Visi & Misi</a>
      <a href="#majors" class="py-2">Jurusan</a>
      <a href="#extracurricular" class="py-2">Ekstrakurikuler</a>
