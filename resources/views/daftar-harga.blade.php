...
<section class="py-20 px-6 bg-white" data-aos="fade-up" data-aos-duration="1000">
  <div class="max-w-6xl mx-auto">
    <h2 class="text-3xl text-[#7CB518] md:text-4xl font-extrabold text-center mb-10">
      Tabel Biaya Pendidikan <p class="text-black">SMP SMA & SMK Citra Negara Tahun Ajaran 2026/2027</p>
    </h2>

     <!-- Tombol Daftar SPMB (hanya tampil di mobile) -->
   <div class="flex justify-center mt-8 mb-8 md:hidden">
        <a href="/spmb" class="inline-block bg-white border-2 border-[#7CB518] text-[#7CB518] font-semibold px-8 py-3 rounded-full shadow-sm transition-all duration-300 hover:bg-[#7CB518] hover:text-white active:scale-95">
      ...
      <table class="w-full text-sm text-left text-gray-700">
        ...
        <tbody class="divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right">2.200.000</td>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right">2.900.000</td>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right">1.450.000</td>
            <td class="px-6 py-4 text-right">3.500.000</td>
            <td class="px-6 py-4 text-right">4.950.000</td>
            <td class="px-6 py-4 text-right">1.450.000</td>
          </tr>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right">2.150.000</td>
            <td class="px-6 py-4 text-right">3.600.000</td>
            <td class="px-6 py-4 text-right">5.750.000</td>
            <td class="px-6 py-4 text-right">2.150.000</td>
          </tr>
          ...
          <tr>
            <td class="px-6 py-4 font-medium">SMA</td>
          ...
          <tr>
            ...
            <td class="px-6 py-4 text-right">2.100.000</td>
            <td class="px-6 py-4 text-right">3.000.000</td>
            <td class="px-6 py-4 text-right">5.100.000</td>
            <td class="px-6 py-4 text-right">2.100.000</td>
          </tr>
          
          <!-- SMP -->
          <tr>
            <td class="px-6 py-4 font-medium">SMP Plus</td>
            <td class="px-6 py-4">Program Unggulan</td>
            <td class="px-6 py-4 text-right">1.300.000</td>
            <td class="px-6 py-4 text-right">2.400.000</td>
            <td class="px-6 py-4 text-right">3.700.000</td>
            <td class="px-6 py-4 text-right">1.300.000</td>
          </tr>

          <tr>
            <td class="px-6 py-4 font-medium">SMP Reguler</td>
            <td class="px-6 py-4">Program Reguler</td>
            <td class="px-6 py-4 text-right">1.000.000</td>
